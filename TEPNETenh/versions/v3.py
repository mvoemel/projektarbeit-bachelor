...
HYPER_PARAMETERS = {
    'batch_size': 64, 
    'learning_rate': 0.0012755680432249667, 
    'dropout_rate': 0.11792747175814695, 
    'l2_reg': 0.0005915217137821515, 
    'ff_dim': 59, 
    'num_layers': 4, 
    'num_heads': 4, 
    'activation': 'relu', 
...
HYPER_PARAMETERS = {
    'batch_size': 16, 
    'learning_rate': 0.00010165521393155528, 
    'dropout_rate': 0.3575037388911965, 
    'l2_reg': 0.0016339476006754783, 
    'ff_dim': 200, 
    'num_layers': 4, 
    'num_heads': 39, 
    'activation': 'relu', 
