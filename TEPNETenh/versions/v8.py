...
from tensorflow.keras.layers import Input, Dense, GlobalAveragePooling1D, Dropout, Concatenate, Flatten, Dot, Conv2D, GlobalMaxPooling2D, Reshape, Add, LayerNormalization
...
HYPER_PARAMETERS = {
    'batch_size': 128, 
    'learning_rate': 0.0018403904521258978, 
    'dropout_rate': 0.13841159467909692, 
    'l2_reg': 0.00022266266296386451, 
    'ff_dim': 64, 
    'num_layers': 3, 
    'num_heads': 21, 
...
# HYPER_PARAMETERS = {
#     'batch_size': 64, 
#     'learning_rate': 0.0032911586783875425, 
#     'dropout_rate': 0.16265300138726627, 
#     'l2_reg': 0.009500132352791754, 
#     'ff_dim': 89, 
#     'num_layers': 3, 
#     'num_heads': 40, 
#     'activation': 'tanh', 
...
def create_model(hparams, embed_dim=64, feature_dim=12):
    print("Building Model v8 (Symmetric Cross-Attention + Transformer Block + Interaction Map (2D CNN) + Deep ResNet Classifier Head)")
